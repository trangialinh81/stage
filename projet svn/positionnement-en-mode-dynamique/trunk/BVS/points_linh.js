			...
			an = 0;
				...
				function point_it(event){
					...
					pos_x = event.offsetX?(event.offsetX):event.pageX-document.getElementById("imgCapteur").offsetLeft - 5;
					pos_y = event.offsetY?(event.offsetY):event.pageY-document.getElementById("imgCapteur").offsetTop - 80;
					
					//pos_x = document.getElementById("corps").offsetLeft;
					//pos_y = document.getElementById("corps").offsetTop; 23 99
					//.pos_x = document.getElementById("pointer_div").offsetLeft; 778 197 50 109
					//pos_y = document.getElementById("pointer_div").offsetTop;
				if (indice == 0 || an == 1)
					{
						if (indice == 0)
							indice = 1;
